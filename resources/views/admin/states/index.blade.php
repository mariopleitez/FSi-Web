                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Lista de departamentos</h6>
                                <div class="table-responsive m-t-40">
                                    <a data-toggle="modal" href="#modalDefault" link="{{ route('states.create') }}" class="btn btn-primary showModalButton" title="Nuevo departamento">
                                        Nuevo (+)
                                    </a>
                                    <br/>
                                    <table id="departamentos-datatable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Departamento</th>
                                                <th>Pais</th>
...
@push('scripts')
    ...
    <script>
        $(function() {
            var oTable = $('#departamentos-datatable').DataTable({
                processing: true,
                serverSide: true,
