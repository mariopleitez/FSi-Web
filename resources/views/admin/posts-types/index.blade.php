	    ...
	    <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Tipos de Posts</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Tipos de post</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tipo de Posts</h4>
                                <h6 class="card-subtitle">Lista de tipo de posts.</h6>
                                <div class="table-responsive m-t-40">
                                    <a data-toggle="modal" href="#modalDefault" link="{{ route('post-types.create') }}" class="btn btn-primary showModalButton" title="Nuevo tipo de post">
                                        Nuevo (+)
                                    </a>
                                    <br/>
