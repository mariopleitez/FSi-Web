	    ...
	    <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Suscripciones</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Lista de suscripciones</h6>
                                <div class="table-responsive m-t-40">
                                    {{-- <a data-toggle="modal" href="#modalDefault" link="{{ route('plans.create') }}" class="btn btn-primary showModalButton" title="Nuevo plan">
                                        Nuevo (+)
                                    </a>
                                    <br/> --}}
        ...
        $(function() {
            var oTable = $('#posts-datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'subscripcion', name: 'subscripcion.name'},
