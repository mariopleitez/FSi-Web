...
<!-- Begin page content -->
<div class="row page-content" style="margin-top:0px">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="cover profile">
                <div class="wrapper">
                  <div class="image">
                    <img src="{{ asset('img/profile-cover.jpg') }}" class="show-in-modal" alt="people">
                  </div>
                  <ul class="friends">
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/guy-6.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/woman-3.j') }}pg" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/guy-2.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/guy-9.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/woman-9.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/guy-4.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/guy-1.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="{{ asset('img/woman-4.jpg') }}" alt="people" class="img-responsive">
                      </a>
                    </li>
                    <li><a href="#" class="group"><i class="fa fa-users"></i></a></li>
                  </ul>
                </div>
                <div class="cover-info">
                  <div class="avatar">
                    <img src="{{ asset('img/guy-3.jpg') }}" alt="people">
                  </div>
                      ...
                      <div class="box box-widget">
                        <div class="box-header with-border">
                          <div class="user-block">
                            <img class="img-circle" src="{{ asset('img/guy-3.jpg') }}" alt="User Image">
