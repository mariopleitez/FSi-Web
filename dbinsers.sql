...
-- Dumping structure for table fundasierra.posts_relations_users
DROP TABLE IF EXISTS `posts_relations_users`;
CREATE TABLE IF NOT EXISTS `posts_relations_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `deleted_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_posts_relations_users_posts` (`post_id`),
  KEY `FK_posts_relations_users_users` (`user_id`),
  KEY `FK_posts_relations_users_relations` (`relation_id`),
  CONSTRAINT `FK_posts_relations_users_posts` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_posts_relations_users_relations` FOREIGN KEY (`relation_id`) REFERENCES `relations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_posts_relations_users_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Dumping data for table fundasierra.posts_relations_users: ~1 rows (approximately)
/*!40000 ALTER TABLE `posts_relations_users` DISABLE KEYS */;
INSERT INTO `posts_relations_users` (`id`, `post_id`, `user_id`, `relation_id`, `active`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
	(1, 16, 1, 1, 1, '2018-09-08 14:23:27', '2018-09-08 14:23:28', NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `posts_relations_users` ENABLE KEYS */;

-- Dumping structure for table fundasierra.relations
...
-- Dumping data for table fundasierra.relations: ~1 rows (approximately)
/*!40000 ALTER TABLE `relations` DISABLE KEYS */;
INSERT INTO `relations` (`id`, `name`, `active`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
	(1, 'likes', 1, '2018-09-08 14:23:04', '2018-09-08 14:23:04', NULL, NULL, NULL, NULL);
...
INSERT INTO `states` (`id`, `country_id`, `name`, `active`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
	...
	(4, 1, 'Cabañas', 1, '2015-06-06 15:53:59', '2015-06-06 15:53:59', NULL, 1, 1, NULL),
